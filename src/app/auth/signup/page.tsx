...
import { Mail, Lock, Eye, EyeOff, AlertCircle, User as UserIcon } from 'lucide-react'
...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      // Add a small delay to simulate the authentication process
      await new Promise(resolve => setTimeout(resolve, 1000))
      
      const result = await auth.signInWithPopup({ providerId: 'google.com' })
      if (result.user) {
        router.push('/dashboard')
      }
    } catch (error: any) {
